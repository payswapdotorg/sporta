/**
 * Deterministic W401 test fixtures: W206-shaped pitch track observations,
 * W209-shaped commentary event candidate observations, W005 stores, and W006
 * engines with a fixed wall-clock (docs/testing/HARNESS.md — synthetic,
 * rights-free fixtures only; no `Date.now`, no `Math.random`).
 */
import {
  PITCH_AXES,
...
import type { EntityKind, Observation, SourceModality } from "@sporta/contracts";
...
export const SESSION_ID = "sess-w401";
...
/**
 * The synthetic multi-stream e2e fixture: 40 pitch-space track observations
 * (10 frames × 3 participants + 1 ball, W206-shaped) plus 5 W209-shaped
 * commentary candidates (kickoff, pass, goal, fulltime, other).
 *
 * Final-frame geometry (t = 10_000): ball at (50, 34) with confidence 0.9;
 * p1 at (54, 34) — distance 4, outside the default 2 m radius; p2 at
 * (49, 34) — distance 1, the nearest participant; p3 at (50, 37) — distance
 * 3, outside. The possession winner is therefore p2 with
 * `0.9 * 0.8 * (1 - 1 / 2)`.
 */

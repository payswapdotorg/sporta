...
- J001-J003, J015: NOT_STARTED (final hardening waves); J008-J010 MERGED @fd41352 (domain-side; UI surfaces later); J011 MERGED @e1c367b (Worker B wave 3: operator contextual navigation); J014 MERGED @6bd9753 (Worker B: sqlite identity plane + real three-process restart battery + public-route in-memory audit)

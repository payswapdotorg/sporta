# W909 browser E2E — run mu3velul

Target: http://127.0.0.1:3909 (production build, port 3909)

**8 passed / 0 failed** — 111 assertions passed, 0 failed.
...
- ✅ **watch page renders the player for the alt-text check** — selector .player-stage[role='img']
...
- ✅ **the nav shows the account** — .account-name="e2e-viewer-mu3velul"
...
- ✅ **the nav shows the same account after login** — .account-name="e2e-viewer-mu3velul"
...
- ✅ **the watch page renders the player for the seeded session** — session=sess-1; selector .player-stage[role='img']
...
- ✅ **the switch did NOT reload the page (window marker survives)** — marker="e2e-alive-mu3velul"
...
- ✅ **the watch page is open for the playback checks** — selector .player-stage[role='img']
